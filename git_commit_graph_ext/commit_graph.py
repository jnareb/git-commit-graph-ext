# AUTOGENERATED! DO NOT EDIT! File to edit: ../09_git.ipynb.

# %% auto 0
__all__ = ['sparse_clone', 'get_repo', 'repo_generate_adjlist', 'repo_adjlist_to_graph', 'repo_to_graph', 'commit_graph']
...
# saving to a file
from .checkpoint import _savefile_name
