# AUTOGENERATED! DO NOT EDIT! File to edit: ../03_example_graphs.ipynb.

# %% auto 0
__all__ = ['crown_DAG', 'small_DAG_FELINE', 'tree_DAG', 'levels_DAG_FELINE', 'RCH_graph', 'commit_graph_Stolee']

# %% ../03_example_graphs.ipynb 4
import networkx as nx

# %% ../03_example_graphs.ipynb 8
def crown_DAG():
...
def levels_DAG_FELINE():
    ...
    -------
    graph : networkx.DiGraph
        Example "filter-level" DAG (example in Figure 9 in FELINE paper)
    """
    lf=nx.DiGraph()
